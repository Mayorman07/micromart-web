 ...
 * Persists JWT and UserID to localStorage upon successful validation.
 */
const AdminLogin = () => {
     ...
     * Communicates with the Spring Boot auth service.
     */
    const handleSubmit = async (e) => {
        ...
        try {
            // Pointing to the central user service login endpoint
            ...
            // Brief delay to allow the success state UI to render
    ...
    // Shared input styling for consistent UI across the login form
